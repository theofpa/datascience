...
* yhat [ScienceOps](http://cloud.yhathq.com/) an online framework to expose an API of your ML code, and [ScienceBox](http://docs.yhathq.com/sciencebox/intro/index.html), an EC2 data workstation
